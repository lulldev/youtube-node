...
/**
* Set private key by constructor
* @param {string} key
*/
var YouTube = function(key) {
  ...
  if (typeof key !== 'string') {
    throw 'Please set a private key.';
  }
  ...
  */
  self.related = function(id, maxResults, callback) {
    ...
    /**
    * Video caption list (transcripts) by video id
    * Using 
    * @param {string} videoId
    * @param {function} callback
    */
    self.getCaptionListByVideoId = function(videoId, callback) {
      var validate = self.validate();
      ...
      if (validate !== null) {
        ...
        self.addParam('type', 'list');

        self.request(self.getUrl('captions'), callback);
      }
    };
};
