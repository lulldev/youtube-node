...
describe('Youtube', function () {
  ...
  it('getCaptionList', function (done) {
    var youTube = new YouTube(config.key);
    youTube.getCaptionListByVideoId('dhwpLACAls8', function (err, response) {
      response.should.have.property('kind', 'youtube#captionListResponse');
      done();
    });
  });
